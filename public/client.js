...
{type: 'underground', title: "Underground Lemon", description: "It's dark. Really dark. And the fog machine is on full power. Somewhere in the darkness a mystical creature is lurking below the surface of the normal world. The Underground Lemon's pulse is in sync with the bpm of the low frequency bass of its favorite electronic music. ", image: "assets/underground.png"},
{type: 'hiphop', title: "Hiphop Apple", description: "When the pimp's in the crib, drop it like it's hot...as fresh apple pie. The Hiphop Apple also known as the rap-apple is a rhythmical beast with swagger in each step it takes. Freshness is amongst the staple goods of this fruit. If you aint limpin', you aint pimpin', and the priest of the hiphop chapel, is the notorious rap-apple.", image: "assets/hip-hop.png"},
{type: 'metalhead', title: "Metalhead Kiwi", description: "Bite the head of a bat and bang your head to the screaming guitars. Drums like stampeding herds of mammoths and black as the primary color. The Metalhead Kiwi is friends with darkness and buddy with the beast. A selective music lover to the bone, who wipes its butt with sheets of pop lyrics.", image: "assets/rocker.png"}
]
